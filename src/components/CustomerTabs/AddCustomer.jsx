  ...
  return (
    <div>
      <form onSubmit={handleFormSubmit}>
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="customerCode" className="block text-sm font-medium leading-6 text-gray-900">
                Customer Code
              </label>
              <div className="mt-2">
                <input
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-2xl font-semibold leading-7 text-gray-900">Bill to Details Form.</h2>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="font-semibold leading-7 text-gray-900 text-2xl">Ship to Details.</h2>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-4">
              <label htmlFor="shipAddress" className="block text-sm font-medium leading-6 text-gray-900">
                Address
              </label>
              <div className="mt-2">
                <input
            ...
            <br></br>
            <div className="sm:col-span-2">
              <label htmlFor="shipCountry" className="block text-sm font-medium leading-6 text-gray-900">
                Country
              </label>
              <div className="mt-2">
                <select
            ...
            <div className="sm:col-span-2">
              <label htmlFor="shipState" className="block text-sm font-medium leading-6 text-gray-900">
                State
              </label>
              <div className="mt-2">
                <select
            ...
            <div className="sm:col-span-3">
              <label htmlFor="shipDistrict" className="block text-sm font-medium leading-6 text-gray-900">
                District
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-3">
              <label htmlFor="ship_police-station" className="block text-sm font-medium leading-6 text-gray-900">
                Police Station
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-2">
              <label htmlFor="ship_postal-code" className="block text-sm font-medium leading-6 text-gray-900">
                ZIP / Postal code
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-3">
              <label htmlFor="shipEmail" className="block text-sm font-medium leading-6 text-gray-900">
                Email
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-3">
              <label htmlFor="ship-GST No." className="block text-sm font-medium leading-6 text-gray-900">
                GST No.
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-3">
              <label htmlFor="ship-Tin No." className="block text-sm font-medium leading-6 text-gray-900">
                TIN No.
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-3">
              <label htmlFor="ship-pan" className="block text-sm font-medium leading-6 text-gray-900">
                Pan
              </label>
              <div className="mt-2">
                <input
