...
const ViewCustomer = () => {
  ...
  return (
    <div className="m-2 md:mt-20 p-2 md:p-10 bg-white rounded-3xl">
      <div className="flex justify-start gap-3 mb-5">
      <button className="border-1 px-3 py-1"  onClick={handleBack}>
      <BiArrowBack className="text-gray-500"/>
      </button>
      <h2 className="text-center text-xl underline font-bold mb-3">View Customer</h2>
      </div>
      <form>
